...
def warn( msg ):
    print( bcolors.FAIL + "WANRING! " + bcolors.ENDC + msg)
...
def main():
    ...
    for file in filelist:
        ...
        if (len(datasets) != 1):
            warn("we found more than one dset in the file...")
    ...
    # if desried, we read the actual data time from the filename and not from 
